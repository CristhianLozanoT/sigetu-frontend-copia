...
import 'package:sigetu/features/administrative/presentation/screens/administrative_screen.dart';
import 'package:sigetu/features/administrative/presentation/screens/administrative_history_screen.dart';
...
class AdministrativeHomeShell extends StatefulWidget {
  ...
  @override
  State<AdministrativeHomeShell> createState() =>
      _AdministrativeHomeShellState();
}
...
class _AdministrativeHomeShellState extends State<AdministrativeHomeShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final pages = IndexedStack(
      index: _currentIndex,
      children: [
        _buildNavigator(0, const AdministrativeScreen()),
        _buildNavigator(1, const AdministrativeHistoryScreen()),
